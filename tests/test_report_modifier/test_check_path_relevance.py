...
from reportmodifier.ReportModifier import _check_path_relevance
...
class TestPathRelevance(unittest.TestCase):
    ...
    def test_path_is_not_relevant(self):
        with mock.patch('reportmodifier.ReportModifier._get_keyword_call_path',
    ...
    @patch('reportmodifier.ReportModifier._get_keyword_call_path',
